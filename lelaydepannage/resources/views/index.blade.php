    ...
    <div class="indexBody">
        ...
        <div class="services">
            <div>
                ...
                <br/>Pour palier à cette difficulté, je met à disposition mon savoir faire et mon matériel afin de
                livrer
            ...
            <div style="background-color: #FF9000">
                ...
                <p>Il reste souvent beaucoup de déchet, de matériel dont nous n'avons plus l'utilité après l'achat d'un
                    ...
                    <br/>Afin de vous faciliter la tâche dans votre transition, je vous viens en aide pour débarrasser
                    tous
            ...
            <div>
                ...
                <p>Ma société étant agréee pour la destruction d'épave, je viens chez vous récuperer le véhicule,
                    j'établis
                    alors un CERFA de destruction que vous devrez fournir à votre assurance où pour bénéficier de la
                    prime à
                    descrution lors de l'achat d'un nouveau véhicule.
                    <br/>Peut importe l'état du véhicule, je viendrais vous en débarasser. Seul impératif, pouvoir finir
                    la
                    carte grise.
            </div>
